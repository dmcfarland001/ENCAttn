...
(function () {
    ...
    function M(a, b) {
        ...
        if (c = lineDashTypeMap[a || "solid"])for (var d = 0; d < c.length; d++)c[d] *= b; else c = [];
        return c
    }

    function F(a, b, c, d) {
        if (a.addEventListener)a.addEventListener(b,
            c, d || !1); else if (a.attachEvent)a.attachEvent("on" + b, function (b) {
            b = b || window.event;
    ...
    function C(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)for (this.stripLines =
                                                                                     [], b = 0; b < this._options.stripLines.length; b++)this.stripLines.push(new ka(this.chart, this._options.stripLines[b], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var t = !!document.createElement("canvas").getContext, la = {
        Chart: {
            width: 500,
            height: 400,
            zoomEnabled: !1,
        ...
        return function (k, p, h) {
            var l = h ? h.days : b, n = h ? h.months : d, m = h ? h.shortDays : c, q = h ? h.shortMonths : e;
            h = "";
            var r = !1;
        ...
        b = String(b);
        var g = 1, k = c = "", p = -1, h = [], l = [], n = 0, m = 0, q = 0, r = !1, s = 0, k = b.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        b = null;
        for (var w = 0; k && w < k.length; w++)if (b = k[w], "." === b && 0 > p)p = w; else {
            ...
            0 > p ? (h.push(b), "#" === b || "0" === b ? n++ : "," === b && q++) : (l.push(b), "#" !== b && "0" !==
            b || m++)
        }
        ...
        a = (b[1] + "").split("");
        g && "0" === g[0] && g.shift();
        for (w = r = k = m = p = 0; 0 < h.length;)if (b = h.pop(), "#" === b || "0" === b)if (p++, p === n) {
            var v = g, g = [];
            if ("0" === b)for (b = n - m - (v ? v.length : 0); 0 < b;)v.unshift("0"), b--;
            for (; 0 < v.length;)c = v.pop() + c, w++, 0 === w % r && (k === q && 0 < v.length) && (c = f + c);
            d && (c = "-" + c)
        } else 0 < g.length ? (c = g.pop() + c, m++, w++) : "0" === b && (c = "0" + c, m++, w++), 0 === w % r && (k ===
    ...
    G.prototype.updateOption = function (a) {
        var b = la[this._defaultsKey], c = this._options.theme ? this._options.theme : this.chart && this.chart._options.theme ? this.chart._options.theme : "theme1", d = {}, e = this[a];
    ...
    u.prototype._updateOptions =
        function () {
            ...
            this._options.zoomEnabled ? (this._zoomButton || (R(this._zoomButton = document.createElement("button")), P(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton),
            ...
            this._menuButton ?
                this.exportEnabled ? ga(this._menuButton) : R(this._menuButton) : this.exportEnabled && t && (this._menuButton = document.createElement("button"), P(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), F(this._menuButton, "click", function () {
            ...
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? P(a,
                a._zoomButton, "zoom") : P(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && P(a, a._resetButton, "reset"));
            if ("undefined" === typeof la.Chart.creditHref)this.creditHref = "http://canvasjs.com/", this.creditText = "CanvasJS.com"; else var c = this.updateOption("creditText"), d = this.updateOption("creditHref");
    ...
    u.prototype._initialize = function () {
        ...
        this.layoutManager = new Y(0, 0, this.width, this.height,
            2);
    ...
    u.prototype.render = function (a) {
        ...
        c ? ga(this._zoomButton, this._resetButton) : R(this._zoomButton,
            this._resetButton);
        this._processData();
        ...
        if (this._options.subtitles)for (a = 0; a < this._options.subtitles.length; a++)this.subtitles = [], c = new ia(this, this._options.subtitles[a]), this.subtitles.push(c), c.dockInsidePlotArea ? b.push(c) : c.render();
        this.legend = new ja(this, this._options.legend, this.theme);
        for (a = 0; a < this.data.length; a++)(this.data[a].showInLegend || "pie" === this.data[a].type ||
        "doughnut" === this.data[a].type) && this.legend.dataSeries.push(this.data[a]);
        this.legend.dockInsidePlotArea ? b.push(this.legend) : this.legend.render();
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)C.setLayoutAndRender(this.axisX, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace()); else if ("none" === this.plotInfo.axisPlacement)this.preparePlotArea(); else return;
    ...
    u.prototype._processMultiseriesPlotUnit =
        function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)var n = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ?
                ...
                for (p = 0; p < k.dataPoints.length; p++) {
                    ...
                    k.dataPoints[p].x.getTime ?
                        (f = !0, d = k.dataPoints[p].x.getTime()) : d = k.dataPoints[p].x;
                    e = k.dataPoints[p].y;
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    e < b.min && (b.min = e);
    ...
    u.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], k = [], p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = this.data[a.dataSeriesIndexes[p]], l = 0, n = !1, m = !1;
                ...
                for (l = 0; l < h.dataPoints.length; l++) {
                    ...
                    if (0 < l) {
                        ...
                        null !== e && null !== h.dataPoints[l - 1].y &&
            ...
            for (l in g)g.hasOwnProperty(l) && !isNaN(l) && (a = g[l], a < b.min && (b.min = a), a > b.max && (b.max = a), l < c.viewPortMin || l > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)));
            for (l in k)k.hasOwnProperty(l) && !isNaN(l) && (a = k[l], a < b.min && (b.min = a), a > b.max && (b.max = a), l < c.viewPortMin || l > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)))
        }
    };
    u.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo,
                ...
                var l = this.data[a.dataSeriesIndexes[h]], n = 0, m = !1, q = !1;
                ...
                for (n = 0; n < l.dataPoints.length; n++) {
                    ...
                    if (0 < n) {
                        ...
                        null !== e && null !== l.dataPoints[n - 1].y && (w = e - l.dataPoints[n - 1].y, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w))
                    }
                    if (!(d < r) || m) {
                        if (!m && (m = !0, 0 < n)) {
                            n -= 2;
                        ...
                        d < c.viewPortMin && (c.viewPortMin = d);
                        d > c.viewPortMax && (c.viewPortMax = d);
                        null !== e && (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] :
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, k = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            ...
            for (l = 0; l < h.dataPoints.length; l++) {
                ...
                if (!(d < q) || n) {
                    ...
                    d < c.viewPortMin && (c.viewPortMin = d);
                    d > c.viewPortMax && (c.viewPortMax = d);
                    null !== e && (f < b.viewPortMin && (b.viewPortMin =
    ...
    u.prototype.getDataPointAtXY = function (a, b, c) {
        ...
        a = null;
        b = !1;
        for (c = 0; c < d.length; c++)if ("line" === d[c].dataSeries.type || "stepLine" === d[c].dataSeries.type || "area" === d[c].dataSeries.type || "stepArea" === d[c].dataSeries.type)if (e = N("markerSize", d[c].dataPoint,
                    d[c].dataSeries) || 8, d[c].distance <= e / 2) {
            b = !0;
            break
        }
    ...
    u.prototype.getObjectAtXY = function (a, b, c) {
        var d = null;
        if (c = this.getDataPointAtXY(a, b, c || !1))d = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (t)d = va(a, b, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
            var e =
                this.legend.items[c];
    ...
    u.prototype._zoomPanToSelectedRegion = function (a, b, c, d, e) {
        ...
        for (g = 0; g < p.length; g++) {
            var l = p[g], n = l.convertPixelToValue({x: a, y: b}), m = l.convertPixelToValue({x: c, y: d});
            if (n > m)var q = m, m = n, n = q;
            if (isFinite(l.dataInfo.minDiff))if (!(Math.abs(m - n) < 3 * Math.abs(l.dataInfo.minDiff) || n < l.minimum || m > l.maximum))h.push(l),
                f.push({val1: n, val2: m}), k = !0; else if (!e) {
                k = !1;
                break
            }
        }
    ...
    u.prototype.renderIndexLabels = function (a) {
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = f = e = 0, p = 0; p < this._indexLabels.length; p++) {
            ...
            if (null !== w && "" !== w) {
                var c = N("indexLabelPlacement", h.dataPoint, h.dataSeries), r = N("indexLabelOrientation", h.dataPoint, h.dataSeries), s = h.direction, v = h.dataSeries.axisX, x = h.dataSeries.axisY, m = new H(a, {
                    x: 0,
                    y: 0,
                ...
                m.measureText();
                if (0 <= g.indexOf("line") ||
                    0 <= g.indexOf("area") || 0 <= g.indexOf("bubble") || 0 <= g.indexOf("scatter")) {
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    c && (c = "inside"); else if ("bubble" === g || "scatter" === g)c = "inside";
                    l = h.point.x - d / 2;
                    ...
                    g) - d - e : g - d - e))) : (f = Math.max(h.bounds.x1, b.x1), Math.min(h.bounds.x2, b.x2), c = 0 <= g.indexOf("range") ? 0 > s ? Math.max(h.bounds.x1, b.x1) + d / 2 + e : Math.min(h.bounds.x2, b.x2) - d / 2 - e : (Math.max(h.bounds.x1, b.x1) + Math.min(h.bounds.x2, b.x2)) / 2, l = 0 > s ? Math.max(h.point.x, c) - d / 2 : Math.min(h.point.x, c) - d / 2, l = Math.max(l, f));
                "vertical" === r && (n += k);
                m.x = l;
                m.y = n;
                m.render(!0)
                ...
                for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                    ...
                    if (0 < k.length) {
                        for (var q = !1, l = 0; l < k.length; l++)if (n = k[l].x.getTime ? k[l].x.getTime() : k[l].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[l].y)0 < l && (b.stroke(), t && c.stroke()), q = !0; else {
                            ...
                            h || q ? (b.beginPath(), b.moveTo(n, m), t && (c.beginPath(), c.moveTo(n, m)), q = h = !1) : (b.lineTo(n, m), t && c.lineTo(n, m), 0 == l % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, m), t && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
                            if (0 < k[l].markerSize || 0 < g.markerSize) {
                                var s =
                                    g.getMarkerProperties(l, n, m, b);
                                d.push(s);
                                r = B(r);
                                t && d.push({
                                    x: n,
                ...
                if (0 < k.length) {
                    for (var q = !1, l = 0; l < k.length; l++)if (n = k[l].getTime ? k[l].x.getTime() : k[l].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[l].y)0 < l && (b.stroke(), t && c.stroke()), q = !0; else {
                        ...
                        n = a.axisX.conversionParameters.reference +
                            a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                        m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                        ...
                        h || q ? (b.beginPath(), b.moveTo(n, m), t && (c.beginPath(), c.moveTo(n, m)), q = h = !1) : (b.lineTo(n, r), t && c.lineTo(n, r), b.lineTo(n, m), t && c.lineTo(n, m), 0 == l % 500 &&
                        (b.stroke(), b.beginPath(), b.moveTo(n, m), t && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
                        if (0 < k[l].markerSize || 0 < g.markerSize)r = g.getMarkerProperties(l, n, m, b), d.push(r), s = B(s), t && d.push({
                            x: n,
                            y: m,
                            ctx: c,
                            type: r.type,
    ...
    u.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var p = k.dataPoints;
                c.setLineDash &&
                c.setLineDash(M(k.lineDashType, k.lineThickness));
                var h = k.id;
                ...
                var l = 0, n, m, q = [];
                c.beginPath();
                if (0 < p.length)for (l = 0; l < p.length; l++)if (n = p[l].getTime ? p[l].x.getTime() : p[l].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof p[l].y)0 < l && (b(q), q = []); else {
                    n = a.axisX.conversionParameters.reference +
                        a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
    ...
    var I = function (a, b, c, d, e, f, g, k, p, h, l, n,
        ...
        a.restore();
        !0 === p && (a.save(), a.beginPath(), a.moveTo(b, c), a.lineTo(b + q, c + q), a.lineTo(d - q, c + q), a.lineTo(d, c), a.closePath(), g = a.createLinearGradient((d + b) / 2, c + q, (d + b) / 2, c), g.addColorStop(0,
            f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === h && (a.save(), a.beginPath(), a.moveTo(b, e), a.lineTo(b + q, e - q), a.lineTo(d - q, e - q), a.lineTo(d, e), a.closePath(), g = a.createLinearGradient((d + b) / 2, e - q, (d + b) / 2, e), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === l && (a.save(), a.beginPath(), a.moveTo(b, c), a.lineTo(b + q, c + q), a.lineTo(b + q, e - q), a.lineTo(b, e), a.closePath(), g = a.createLinearGradient(b + q, (e + c) / 2, b, (e + c) / 2), g.addColorStop(0,
    ...
    u.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length)for (var q = 5 < l && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)if (m[e].getTime ? k = m[e].x.getTime() : k = m[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                    ...
                    {id: c, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: g, x2: r, y2: s};
                    c = B(c);
    ...
    u.prototype.renderStackedColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = 0, k, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth :
                1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, l = a.axisX.dataInfo.minDiff;
            ...
            h < g) && (h = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, g));
            l < g && (l = g);
            l > h && (l = h);
            b.save();
            t && this._eventManager.ghostCtx.save();
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h], m = this.data[n], q = m.dataPoints;
                if (0 < q.length) {
                    var r = 5 < l && m.bevelEnabled ? !0 : !1;
                    b.strokeStyle = "#4572A7 ";
                    for (g = 0; g < q.length; g++)if (c =
    ...
    u.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(l) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && g > h && (g = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, h));
            ...
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            t && (this._eventManager.ghostCtx.rect(d.x1, d.y1,
                d.width, d.height), this._eventManager.ghostCtx.clip());
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h], m = this.data[n], q = m.dataPoints;
                if (0 < q.length)for (var r = 5 < l && m.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++)if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                    d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                    k = a.axisY.conversionParameters.reference +
                        a.axisY.conversionParameters.pixelPerUnit * ((0 !== a.dataPointYSums[c] ? 100 * (q[g].y / a.dataPointYSums[c]) : 0) - a.axisY.conversionParameters.minimum);
                    var s = d - a.plotType.plotUnits.length * l / 2 + a.index * l << 0, w = s + l << 0, v;
                    if (0 <= q[g].y) {
                        var x = e[c] ? e[c] : 0;
                        k -= x;
    ...
    u.prototype.renderBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = 0, f, g, k, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ?
                this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, l = a.axisX.dataInfo.minDiff;
            isFinite(l) || (l = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length) {
                    ...
                    for (e = 0; e < m.length; e++)if (m[e].getTime ? k = m[e].x.getTime() : k = m[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                        ...
                        g = g - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + d) *
                            l << 0;
                        var r = g + l << 0, s;
                        0 <= m[e].y ? s = p : (s = f, f = p);
                        c = m[e].color ? m[e].color : n._colorSet[e % n._colorSet.length];
    ...
    u.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            l = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum -
                a.axisX.viewportMinimum) * Math.abs(l) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && g > h && (g = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, h));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && h < g) && (h = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, g));
            l < g && (l = g);
            l > h && (l = h);
    ...
    u.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = 0, k, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
                this.dataPointWidth : 0.15 * this.height << 0, l = a.axisX.dataInfo.minDiff;
            isFinite(l) || (l = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < q.length) {
                    var r = 5 < l && m.bevelEnabled ? !0 : !1;
                    b.strokeStyle = "#4572A7 ";
                    for (g = 0; g < q.length; g++)if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin ||
    ...
    u.prototype.renderArea = function (a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = w : 0 > a.axisY.viewportMaximum ?
                v = f.y1 : 0 < a.axisY.viewportMinimum && (v = e.y2), c.lineTo(q, v), c.lineTo(x.x, v), c.closePath(), c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, t && (d.lineTo(q, v), d.lineTo(x.x, v), d.closePath(), d.fill()), c.beginPath(), c.moveTo(q, r), d.beginPath(), d.moveTo(q, r), x = {
                x: q,
                y: r
            })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    for (var y = !0; m < l.length; m++)if (s = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof l[m].y)b(), y = !0; else {
                        ...
                        r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                            (l[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                        n || y ? (c.beginPath(), c.moveTo(q, r), x = {
                            x: q,
                            y: r
                        }, t && (d.beginPath(), d.moveTo(q, r)), y = n = !1) : (c.lineTo(q, r), t && d.lineTo(q, r), 0 == m % 250 && b());
                        ...
                        0 !== l[m].markerSize && (0 < l[m].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(m, q, r, c), g.push(s), z = B(z), t && g.push({
                            x: q,
                            y: r,
                            ctx: d,
                            type: s.type,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = color;
                    c.lineWidth = h.lineThickness;
                    for (c.setLineDash && c.setLineDash(M(h.lineDashType, h.lineThickness)); n < l.length; n++)if (m = l[n].x.getTime ?
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = y;
                    c.lineWidth = h.lineThickness;
                    for (c.setLineDash && c.setLineDash(M(h.lineDashType, h.lineThickness)); m < l.length; m++)if (s = l[m].x.getTime ?
                            l[m].x.getTime() : l[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                        var z = r;
                        "number" !== typeof l[m].y ? (b(), E = !0) : (q = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) + 0.5 << 0, r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (l[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n || E ? (c.beginPath(), c.moveTo(q, r), x = {
                            x: q,
                            y: r
                        }, t && (d.beginPath(), d.moveTo(q, r)), E = n = !1) : (c.lineTo(q,
                            z), t && d.lineTo(q, z), c.lineTo(q, r), t && d.lineTo(q, r), 0 == m % 250 && b()), z = h.dataPointIds[m], this._eventManager.objectMap[z] = {
                            id: z,
                            objectType: "dataPoint",
                            dataSeriesIndex: p,
                            dataPointIndex: m,
    ...
    u.prototype.renderStackedArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                var q = a.dataSeriesIndexes[e], r = this.data[q], s = r.dataPoints, w = !0, v = [], k = r.id;
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        ...
                        if (!(l < a.axisX.dataInfo.viewPortMin ||
                            ...
                            v.push({x: p, y: n - E});
                            f[l] = n - h;
                            if (w)b.beginPath(), b.moveTo(p, h), t && (m.beginPath(), m.moveTo(p, h)), w = !1; else if (b.lineTo(p, h), t && m.lineTo(p, h), 0 == k % 250) {
                            ...
                            0 <= r.dataPointIndexes[l] && 0 !== x.markerSize && (0 < x.markerSize ||
                            0 < r.markerSize) && (l = r.getMarkerProperties(k, p, h, b), d.push(l), markerColor = B(z), t && d.push({
                                x: p,
                                y: h,
                                ctx: m,
                                type: l.type,
    ...
    u.prototype.renderStackedArea100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            xValuePresent =
                [];
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var s = a.dataSeriesIndexes[d], w = this.data[s], v = w.dataPoints;
                w.dataPointIndexes = [];
    ...
    u.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= c)) {
            ...
            b.clip();
            t && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, h = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)for (var n = a.dataSeriesIndexes[l], m = this.data[n], q = m.dataPoints, r = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z ||
            (r = q[e].z, r > p && (p = r), r < h && (h = r));
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), l = 0; l < a.dataSeriesIndexes.length; l++)if (n = a.dataSeriesIndexes[l], m = this.data[n], q = m.dataPoints, 1 == q.length && (c = k), 1 > c ? c = 1 : c > k && (c = k), 0 < q.length)for (b.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                ...
                var r = q[e].z, w = 2 * Math.max(Math.sqrt((p === h ? d / 2 : s + (d - s) / (p - h) * (r - h)) / Math.PI) << 0, 1), r = m.getMarkerProperties(e, b);
                r.size = w;
    ...
    u.prototype.renderScatter = function (a) {
        ...
        if (!(0 >= c)) {
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = a.dataSeriesIndexes[p], l = this.data[h], n = l.dataPoints;
                1 == n.length && (c = k);
                1 > c ? c = 1 : c > k && (c = k);
                if (0 < n.length) {
                    b.strokeStyle = "#4572A7 ";
                    ...
                    for (var m = 0, q = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                        ...
                        (m = l.dataPointIds[e], this._eventManager.objectMap[m] = {
                            id: m,
                            objectType: "dataPoint",
                            dataSeriesIndex: h,
                            dataPointIndex: e,
                            x1: f,
                            y1: g
                        }, m = B(m), t && K.drawMarker(r.x, r.y, this._eventManager.ghostCtx, r.type, r.size, m, m, r.borderThickness), (n[e].indexLabel || l.indexLabel || n[e].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "scatter",
                            dataPoint: n[e],
                            dataSeries: l,
                            point: {x: f, y: g},
    ...
    u.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                var q = a.dataSeriesIndexes[m], r = this.data[q], s = r.dataPoints;
                if (0 < s.length)for (var w = 5 < n && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)if (s[e].getTime ? l = s[e].x.getTime() : l = s[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                    ...
                    var v = f - n / 2 << 0, x = v + n << 0, d = s[e].color ? s[e].color : r._colorSet[0], E = Math.round(Math.max(1, 0.15 * n)), u = 0 === E % 2 ? 0 : 0.5, z = r.dataPointIds[e];
                    this._eventManager.objectMap[z] = {
                        id: z,
                        objectType: "dataPoint",
                        dataSeriesIndex: q,
    ...
    u.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = a.dataSeriesIndexes[p], l = this.data[h], n = l.dataPoints;
                if (0 < n.length)for (var m = 5 < k && l.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)if (n[e].getTime ? g = n[e].x.getTime() :
                    ...
                    f = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                        (n[e].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                    var q = c - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + p) * k << 0, r = q + k << 0, c = n[e].color ? n[e].color : l._colorSet[e % l._colorSet.length];
                    if (d > f) {
                        var s = d, d = f;
                        f = s
                    }
                    ...
                    if (n[e].indexLabel || l.indexLabel ||
                        n[e].indexLabelFormatter || l.indexLabelFormatter)this._indexLabels.push({
    ...
    u.prototype.renderRangeBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h], n = this.data[l], m = n.dataPoints;
                if (0 < m.length) {
                    var q = 5 < p && n.bevelEnabled ? !0 : !1;
                    b.strokeStyle = "#4572A7 ";
                    for (e = 0; e < m.length; e++)if (m[e].getTime ?
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    for (var x = !0; n < h.length; n++)if (s = h[n].x.getTime ? h[n].x.getTime() : h[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if (null !== h[n].y && h[n].y.length &&
    ...
    u.prototype.renderPie = function (a) {
        function b() {
            if (h && l) {
                ...
                for (y = 0; y < l.length; y++) {
                    ...
                    q.push(g);
                    var k = {percent: null, total: null}, n = null, k = p.getPercentAndTotal(h, e);
                    ...
                    g.indexLabelFontWeight = e.indexLabelFontWeight ? e.indexLabelFontWeight :
                    ...
                    g.indexLabelWrap = "undefined" !== typeof e.indexLabelWrap ?
                        e.indexLabelWrap : h.indexLabelWrap;
                    ...
                    g.hemisphere = e > Math.PI / 2 &&
                    e <= 3 * Math.PI / 2 ? "left" : "right";
        ...
        function c(a) {
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < l.length; b++)c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== h.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== h.indexLabelPlacement ?
        ...
        function e(a) {
            for (var b = null, c = 1; c < l.length; c++)if (b =
                    (a + c + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                b = null;
                break
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < l.length) {
                var m = q[a];
                if (0 > b && m.indexLabelTextBlock.y < h || 0 < b && m.indexLabelTextBlock.y > k)return 0;
                var n = 0, p = 0, p = n = n = 0;
                ...
                h = 0;
                h = "right" === m.hemisphere ? x.x + Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(b -
                        x.y, 2)) : x.x - Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(b - x.y, 2));
                ...
                for (k = 1; k < l.length; k++)if (h = (a - k + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) {
                    h = null;
                    break
                } else if (q[h].indexLabelText && q[h].hemisphere === q[a].hemisphere && h !== a && (0 > d(q[h],
                        q[a]) || ("right" === q[a].hemisphere ? q[h].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[h].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))break; else h = null;
                p = h;
                n = e(a);
                k = h = 0;
                0 > b ? (k = "right" === m.hemisphere ? p : n, g = b, null !== k && (p = -b, b = m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 - (q[k].indexLabelTextBlock.y + q[k].indexLabelTextBlock.height / 2), b - p < r && (h = -p, k = f(k, h, c + 1), +k.toFixed(v) > +h.toFixed(v) && (g = b > r ? -(b - r) : -(p - (k - h)))))) : 0 < b && (k = "right" === m.hemisphere ? n : p, g = b, null !== k && (p = b, b = q[k].indexLabelTextBlock.y -
                    q[k].indexLabelTextBlock.height / 2 - (m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2), b - p < r && (h = p, k = f(k, h, c + 1), +k.toFixed(v) < +h.toFixed(v) && (g = b > r ? b - r : p - (h - k)))));
                g && (c = m.indexLabelTextBlock.y + g, b = 0, b = "right" === m.hemisphere ? x.x + Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(c - x.y, 2)) : x.x - Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(c - x.y, 2)), m.midAngle > Math.PI / 2 - t && m.midAngle < Math.PI / 2 + t ? (h = (a - 1 + q.length) % q.length, h = q[h], a = q[(a + 1 + q.length) % q.length], "left" === m.hemisphere && "right" === h.hemisphere &&
        ...
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                if ("inside" !== h.indexLabelPlacement) {
                    ...
                    for (a = 0; a < l.length; a++) {
                        ...
                        k.indexLabelTextBlock.x =
                            x.x + indexLabelRadius * Math.cos(k.midAngle);
                ...
                for (a = 0; a < l.length; a++)if (k = q[a], u = k.indexLabelTextBlock.measureText(), 0 !== u.height && 0 !== u.width)u = u = 0, "right" === k.hemisphere ?
                ...
                (function () {
                    for (var a = -1, b = -1, c = 0, f = !1, g = 0; g < l.length; g++)if (f = !1, t = q[g], t.indexLabelText) {
                        ...
                        if (null !== h) {
                            ...
                            m ? (0 > a && (a = g), h !== a && (b = h, c += -y), 0 === g % Math.max(l.length / 10, 3) && (f = !0)) : f = !0;
        ...
        var p = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var h = this.data[a.dataSeriesIndexes[0]], l = h.dataPoints, n = 10, m = this.plotArea, q = [], r = 2, s = 1.3, t = 20 / 180 * Math.PI, v = 6, x = {
                x: (m.x2 + m.x1) / 2,
                y: (m.y2 + m.y1) / 2
            }, u = 0;
            a = !1;
            for (var y = 0; y < l.length; y++)u += Math.abs(l[y].y), !a && ("undefined" !== typeof l[y].indexLabel && null !== l[y].indexLabel && 0 < l[y].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof l[y].label && null !== l[y].label && 0 < l[y].label.toString().length) && (a = !0);
            if (0 !== u) {
                a = a || "undefined" !== typeof h.indexLabel &&
                    null !== h.indexLabel && 0 < h.indexLabel.toString().length;
                ...
                var A = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? ya(h.innerRadius, z) : 0.7 * z, D = Math.min(A / z, (z - 1) / z);
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                    ...
                    for (b = 0; b < l.length; b++) {
                        ...
                        d > c && ra(p.plotArea.ctx, q[b].center, q[b].radius, f, h.type, c, d, h.fillOpacity,
    ...
    H.prototype._wrapText = function () {
        var a = new String(Z(String(this.text))), b = [], c = this.ctx.font, d = 0, e = 0;
        ...
        for (var h = 0; h < this.dataSeries.length; h++) {
            ...
            if ("pie" !== l.type && "doughnut" !== l.type && "funnel" !== l.type) {
                var n = l.legendMarkerType ? l.legendMarkerType :
                    "line" !== l.type && "stepLine" !== l.type && "spline" !== l.type && "scatter" !== l.type && "bubble" !== l.type || !l.markerType ? S.getDefaultLegendMarker(l.type) : l.markerType, m = l.legendText ? l.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this._options,
                    dataSeries: l,
                    dataPoint: null
                }) : l.name, q = l.legendMarkerColor ? l.legendMarkerColor : l.markerColor ? l.markerColor : l._colorSet[0], r = l.markerSize || "line" !== l.type && "stepLine" !== l.type && "spline" !== l.type ? 0.6 * this.lineHeight : 0, s = l.legendMarkerBorderColor ?
                    l.legendMarkerBorderColor : l.markerBorderColor, t = l.legendMarkerBorderThickness ? l.legendMarkerBorderThickness : l.markerBorderThickness ? Math.max(1, Math.round(0.2 * r)) : 0, m = this.chart.replaceKeywordsWithValue(m, l.dataPoints[0], l, h), n = {
                    markerType: n,
                    markerColor: q,
                    text: m,
                    textBlock: null,
                ...
                var u = l.dataPoints[v], n = u.legendMarkerType ?
                    u.legendMarkerType : l.legendMarkerType ? l.legendMarkerType : S.getDefaultLegendMarker(l.type), m = u.legendText ? u.legendText : l.legendText ? l.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this._options,
                    dataSeries: l,
                    dataPoint: u
                }) : u.name ? u.name : "DataPoint: " + (v + 1), q = u.legendMarkerColor ? u.legendMarkerColor : l.legendMarkerColor ? l.legendMarkerColor : u.color ? u.color : l.color ? l.color : l._colorSet[v % l._colorSet.length], r = 0.6 * this.lineHeight, s = u.legendMarkerBorderColor ? u.legendMarkerBorderColor :
                    l.legendMarkerBorderColor ? l.legendMarkerBorderColor : u.markerBorderColor ? u.markerBorderColor : l.markerBorderColor, t = u.legendMarkerBorderThickness ? u.legendMarkerBorderThickness : l.legendMarkerBorderThickness ? l.legendMarkerBorderThickness : u.markerBorderThickness || l.markerBorderThickness ? Math.max(1, Math.round(0.2 * r)) : 0, m = this.chart.replaceKeywordsWithValue(m, u, l, v), n = {
                    markerType: n,
                    markerColor: q,
                    text: m,
                    textBlock: null,
            ...
            for (h = 0; h < k.length; h++) {
                ...
                if (!(0 >=
                    ...
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!l || l.width + Math.round(n.textBlock.width + 0.1 * this.horizontalSpacing + r + (0 === l.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)l = {
                            items: [],
                            width: 0
                        ...
                        fontStyle: this.fontStyle,
                        textBaseline: "top"
                    }), n.textBlock.measureText(), null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + 0.1 * this.horizontalSpacing + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height <= g ? (l = {
                        items: [],
                        width: 0
                    }, p.push(l)) : (l = p[u], u = (u + 1) % p.length), this.height += n.textBlock.height;
        ...
        for (h = b = 0; h < p.length; h++) {
            ...
            for (k = v = 0; k < l.items.length; k++) {
                ...
                if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth =
                    Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(m - 0.1 * this.lineHeight, q + this.lineHeight / 2), this.ctx.lineTo(m + 0.7 * this.lineHeight, q + this.lineHeight / 2), this.ctx.stroke(), u -= 0.1 * this.lineHeight;
    ...
    S.prototype.getDataPointAtXY = function (a, b, c) {
        ...
        c = c || !1;
        var d = [], e =
            0, f = 0, g = 1, k = !1, p = Infinity, h = 0, l = 0, n = 0;
                    ...
                    switch (this.type) {
                        ...
                        case "ohlc":
                            if (Math.abs(m.x2 - a + m.x1 - a) < m.borderThickness && b >= m.y2 && b <= m.y3 || a >= m.x1 && a <= (m.x2 +
                                m.x1) / 2 && b >= m.y1 - m.borderThickness / 2 && b <= m.y1 + m.borderThickness / 2 || a >= (m.x1 + m.x2) / 2 && a <= m.x2 && b >= m.y4 - m.borderThickness / 2 && b <= m.y4 + m.borderThickness / 2)d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                                distance: Math.min(Math.abs(m.x1 - a), Math.abs(m.x2 - a), Math.abs(m.y2 - b), Math.abs(m.y3 - b))
    ...
    S.prototype.getMarkerProperties =
        function (a, b, c, d) {
            ...
            return {
                ...
                borderThickness: e[a].markerBorderThickness ? e[a].markerBorderThickness :
    ...
    C.prototype.createLabels = function () {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)for (c = sa(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < c; sa(b, this.interval, this.intervalType))a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this._options,
            value: b,
    ...
    C.prototype.createLabelsAndCalculateWidth = function () {
        ...
        if ("left" === this._position || "right" === this._position)for (this.createLabels(), i = 0; i < this._labels.length; i++) {
            var b =
                this._labels[i].textBlock.measureText(), c = 0, c = 0 === this.labelAngle ? b.width : b.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + b.height / 2 * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
            a < c && (a = c);
    ...
    C.prototype.createLabelsAndCalculateHeight = function () {
        ...
        var b, c = 0;
        this.createLabels();
        if ("bottom" === this._position || "top" === this._position)for (c =
    ...
    C.setLayoutAndRender = function (a, b, c, d, e) {
        ...
        if ("normal" === d) {
            ...
            b && (f = Math.round(e.x1 + b.margin), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + n + b.margin), k = Math.round(e.y2 - m - a.margin), b.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
                y2: k,
            ...
            {x1: f, y1: d, x2: g, y2: k, width: g - f, height: k - d});
            ...
            b && (d = Math.round(e.y2 - m - b.margin), k = Math.round(e.y2 - l > b.chart.height - 10 ?
            b.chart.height - 10 : e.y2 - l), b.lineCoordinates.y1 = d, b.lineCoordinates.y2 = d, b.boundingRect = {
                x1: f,
                y1: d,
                x2: g,
                y2: k,
    ...
    C.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)for (d = 0; d < this._labels.length && !this._labels[d].stripLine; d++)this._labels[d].position < this.viewportMinimum || this._labels[d].position > this.viewportMaximum || (a.beginPath(), b = this.getPixelCoordinatesOnAxis(this._labels[d].position),
    ...
    C.prototype.calculateAxisParameters = function () {
        var a =
            this.chart.layoutManager.getFreeSpace(), b = !1;
    ...
    ka.prototype.render = function () {
        ...
        if (0 < b) {
            ...
            if ("bottom" === this.parent._position ||
                "top" === this.parent._position)e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, k = this.chart.plotArea.y2; else if ("left" === this.parent._position || "right" === this.parent._position)g = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2;
            this.ctx.moveTo(e, g);
            this.ctx.lineTo(f, k);
            this.ctx.stroke();
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (g = this.chart.getDataPointAtXY(a,
                        b, !0))this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex = g.dataSeries.index; else if (t)if (g = va(a, b, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
            ...
            if (0 < e.length && (this.highlightObjects(e), this.enabled))if (f = "", f = this.getToolTipInnerHTML({entries: e}), null !== f) {
                ...
                "pie" === e[0].dataSeries.type || "doughnut" === e[0].dataSeries.type || "funnel" === e[0].dataSeries.type || "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? toolTipLeft = a - 10 - this.container.clientWidth : (toolTipLeft = e[0].dataSeries.axisX.conversionParameters.reference + e[0].dataSeries.axisX.conversionParameters.pixelPerUnit * (e[0].dataPoint.x -
                    e[0].dataSeries.axisX.conversionParameters.minimum) - this.container.clientWidth << 0, toolTipLeft -= 10);
    ...
    Q.prototype.getToolTipInnerHTML = function (a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))a = {
            ...
            for (var p = "", k = 0; k < a.length; k++)if (c = a[k].dataSeries, d = a[k].dataPoint, e = a[k].index, f = "", 0 === k && (g && !this.content) &&
                ...
                (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}"; else if ("candlestick" === c.type || "ohlc" === c.type)f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
                null === b && (b = "");
                !0 === this.reversed ?
            ...
            if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" ===
    ...
    u.prototype.replaceKeywordsWithValue =
        function (a, b, c, d, e) {
            var f = this;
            e = "undefined" === typeof e ? 0 : e;
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var g = "#percent", k = "#total", p = this.getPercentAndTotal(c, b), k = isNaN(p.total) ? k : p.total, g = isNaN(p.percent) ? g : p.percent;
                do {
                    p = "";
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                h = null;
                if ("color" === a)return b.color ?
                    b.color : c.color ? c.color : c._colorSet[d % c._colorSet.length];
    ...
    pa.prototype.animate = function (a, b, c, d, e) {
        ...
        for (a = []; 0 < this.animations.length;)if (b = this.animations.shift(), c = (new Date).getTime(), d = 0, b.startTime <= c && (d = e(Math.min(c - b.startTime, b.duration), 0, 1, b.duration), d = Math.min(d, 1), isNaN(d) || !isFinite(d)) &&
            (d = 1), 1 > d && a.push(b), b.animationCallback(d), 1 <= d && b.onComplete)b.onComplete();
        this.animations = a;
